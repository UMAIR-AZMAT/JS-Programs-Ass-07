...
function max_three() {
  ...
  let result_02 = document.getElementById("result_02");
...
function number_check() {
  ...
  if (number >= 0) {
    if (number == 0) {
      ...
      signnnn = "The number is zero";
      document.getElementById("result_03").innerText = signnnn;
    } else {
      console.log("The number is positive");
      signnnn = "The number is positive";
      document.getElementById("result_03").innerText = signnnn;
    }
  } else {
    console.log("The number is negative");
    signnnn = "The number is negative";
    document.getElementById("result_03").innerText = signnnn;
  }
}
// <!--------------------------------------------------------------------------------------------------------------->
...
function units_check() {
  ...
  if (units <= 50) {
    pricee = units * 0.5;
    final_price = pricee + (pricee * 20 / 100;)
